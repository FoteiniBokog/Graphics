...
#define 	GLFW_KEY_CAPS_LOCK     0x0010
...
int main(void)
{
	...
	window = glfwCreateWindow(800, 800, "1B-PYRAMID", NULL, NULL);
	if (window == NULL) {
	...
	//for the scaling 
	/*do {
		while ((((glfwGetKey(window, GLFW_KEY_Q) != GLFW_PRESS) || (GetKeyState(VK_CAPITAL) & 0x0001) != 0) && (((glfwGetKey(window, GLFW_KEY_Z) != GLFW_PRESS) || (GetKeyState(VK_CAPITAL) & 0x0001) != 0) {
			//glm::mat4 myScalingMatrix = glm::scale(x,y,z);
		}
	}*/
